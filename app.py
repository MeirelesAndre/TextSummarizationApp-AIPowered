...
from langchain.prompts import PromptTemplate  # Importando a biblioteca load_summarize_chain que permite a sumarização de texto
...
# Criar uma nova cadeia para tradução do resumo para português
translate_prompt = PromptTemplate(
    input_variables=["text"],
    template="Traduza o seguinte texto para português:\n\n{text}"
)
